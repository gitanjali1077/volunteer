...
import os
#from register.models import Managers
# Build paths inside the project like this: os.path.join(BASE_DIR, ...)

#AUTH_USER_MODEL = 'register.Managers'
...
SECRET_KEY = '6_^)5#=s%!vvgu^--#yab&o@te6hw^7&lwue_3ux#8u$v&97nn'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
#AUTH_USER_MODEL = 'Managers'
ALLOWED_HOSTS = []

#settings for the register app
EMAIL_USE_TLS = True
